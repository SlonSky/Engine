...
//        objects.add(new Director(camera, new Transform(new Vector3f(0f, 10, 0f), camera.getRot(), new Vector3f(1,1,1))));
        ...
        text = new Text(0.8f, 0.8f, 0.15f, "Лорем ипсум", font, new Vector3f(1, 0,0));
        level.addText(text);
...
//        level.getText().get(0).setPos(new Vector2f((float)EditorWindow.y/100f,(float)EditorWindow.z/100f));
//        level.getText().get(0).setSize((float)EditorWindow.x/100f);
//        System.out.println(level.getText().get(0).getSize());
        level.getText().get(0).edit(Integer.toString(engine.getFPS()));

//        level.getGuis().get(0).setPos(new Vector2f((float)EditorWindow.y/100f, (float)EditorWindow.z/100f));
//        level.getGuis().get(0).setScale(new Vector2f((float)EditorWindow.x/100f, (float)EditorWindow.x/100f));


//        level.setText(new Text(EditorWindow.y, EditorWindow.z, EditorWindow.x,
