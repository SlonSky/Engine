...
import Game.entities.FireObject;
import Game.entities.SmokeObject;
...
//        lights.add(new PointLight(new Vector3f(55.5f, 3, -2f), new Vector3f(1, 1,1), 0.2f, new Attenuation(1,0,0)));
        ...
        Player player = new Player(camera, new Transform(new Vector3f(-30f, 5, -55), camera.getRot(), new Vector3f(1,1,1)),
                hands,
